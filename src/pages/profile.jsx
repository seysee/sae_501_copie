...
export default function Profile() {
    ...
    const bannedWords = [
        ...
        "Ejército de Liberación Nacional", "Émirat du Caucase", "islamique", "Province du Sinaï",
        "Euskadi Ta Askatasuna", "Hezb-e Islami", "Macina",
        "Palestine", "Fuerzas Armadas Revolucionarias", "Abou Sayyaf",
        ...
        "Jihad","Kahane Chai", "La Brigade des martyrs d'Al-Aqsa", "La Fédération internationale de la jeunesse sikh",
        ...
        "Organisation Abou Nidal (OAN)", "Parti des travailleurs du Kurdistan", "Proud Boys", "Haqqani",
        "Samidoun", "Sendero Luminoso", "taliban", "The Base", "Three Percenters",
    ];
